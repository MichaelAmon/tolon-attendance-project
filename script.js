...
async function startLocationWatch() {
  ...
  async function validateFace(imageData) {
    const apiKey = '4f4766d9-fc3b-436a-b24e-f57851a1c865'; // Move to .env or backend in production
    const url = 'https://your-face-recognition-api.com/proxy/face-recognition'; // Replace with actual URL
    try {
